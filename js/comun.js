...
exports.iniciarPie = iniciarPie;
exports.modificarTextoPorId = modificarTextoPorId;
exports.crearNodoTexto = crearNodoTexto;
exports.modificarFavicon = modificarFavicon;
exports.insertarSVG = insertarSVG;
/**
 ...
 */
function iniciarPie(nodo_padre, texto_nivel, texto_titulo, texto_tilulo_pagina, { separador = " - " }) {
 ...
 * @return {void} Esta función no devuelve ningún valor.
 */
function modificarTextoPorId(id, texto) {
 ...
 */
function crearNodoTexto(nombre_nodo, texto, id) {
 ...
 * @return {void} Esta función no devuelve ningún valor.
 */
function modificarFavicon(archivo) {
